...
function [valuesTable_start] = get_values_v1(line,gc,logFormat)
    ...
    valuesTable_start = table(gc,st_secs,end_secs,depth,vbd_secs,pitch_secs,roll_secs,vbd_i,pitch_i,roll_i, ...
